        ...
        <div class="col-md-12">
          <div class="box">
            <div class="box-header with-border">
              <h3 class="box-title">Problemas? Entre em contato com os desenvolvedores.</h3>
            ...
            <div class="box-body">
              <div class="row">
                <div class="col-md-12">
                  <form id="notifyTelegram" class="form-horizontal" role="form" method="POST" action="{{ url('/telegram/send-message') }}">
                        {{ csrf_field() }}
                        <div class="col-lg-12 text-center">
                            <textarea name="message" rows="8" cols="40" class="form-control" placeholder="Envie uma mensagem"></textarea>
                            <div class="spacer">
                              <button type="submit" class="btn btn-sm btn-success btn-flat">Enviar</button>
                            </div>
                ...
                <div class="box-body">
                  ...
                  <div class="direct-chat-messages">
                    ...
                    <div class="direct-chat-msg right">
                      ...
                      <div class="direct-chat-text">
                        Hey, it's been some time since we've met. News?
                      </div>
                      <!-- /.direct-chat-text -->
                    </div>
                    <!-- /.direct-chat-msg -->
